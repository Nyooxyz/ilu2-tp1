...
public class Village {
	...
	public String installerVendeur(Gaulois vendeur, String produit, int nbProduit) {
		...
		if(indice != -1) {
			...
			chaine.append("vendeur " + vendeur.getNom() + " vend des " + produit + " à l'étal n°"
					+ (indice+1) + ".\n");
		}
	...
	private static class Marche{
		...
		private void afficherMarche() {
			...
			if(nbEtalVide>0) System.out.println("Il reste " + nbEtalVide + " etals non utilisés dans le marché. \n");
		}
